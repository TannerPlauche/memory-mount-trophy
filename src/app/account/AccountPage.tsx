                ...
                <div className="shadow-lg rounded-lg p-6" style={{backgroundColor: '#3d2317'}}>
                    ...
                    {activeTab === 'profile' && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <h2 className="text-l font-semibold text-amber-100 mr-3">Profile Information</h2>
                                <button
                                    onClick={() => setIsEditing(!isEditing)}
                                    className="flex items-center space-x-2 bg-orange-600 hover:bg-orange-700 text-amber-100 px-4 py-2 rounded-lg transition-colors"
                                >
                                    <Edit size={16} />
                            ...
                            {isEditing ? (
                                <form onSubmit={handleUpdateProfile} className="space-y-4">
                                    ...
                                    <div className="flex space-x-3">
                                        <button
                                            type="submit"
                                            className="bg-orange-600 hover:bg-orange-700 text-amber-100 px-6 py-2 rounded-lg transition-colors"
                                        >
                                            Save Changes
                                        </button>
                                        <button
                                            ...
                                            className="bg-amber-700 hover:bg-amber-800 text-amber-100 px-6 py-2 rounded-lg transition-colors"
                                        >
                                            Cancel
                                        </button>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <p className="text-amber-100">{userData?.name || 'Not provided'}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-amber-300">Role</label>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <label className="block text-sm font-medium text-amber-300">Member Since</label>
                                            <p className="text-amber-100">{userData?.createdAt ? formatDate(userData.createdAt) : 'Unknown'}</p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-amber-300">Total Trophies</label>
                                            <p className="text-amber-100">{trophies.length}</p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-amber-300">Memory Codes Used</label>
                                            <p className="text-amber-100">{memoryCodes.length}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                                        ...
                                        >
                                            <div className="flex items-start justify-between mb-3">
                                                ...
                                                <div className="flex space-x-1">
                                                    {trophy.hasVideo && <Camera size={16} className="text-orange-400" />}
                    ...
                    {activeTab === 'codes' && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <h2 className="text-xl font-semibold text-amber-100">Memory Mounts</h2>
                                <button
                            ...
                            {memoryCodes.length === 0 ? (
                                <div className="text-center py-12">
                                    <Code size={48} className="mx-auto text-amber-500 mb-4" />
                                    <h3 className="text-lg font-medium text-amber-300 mb-2">No memory codes redeemed</h3>
                                    <p className="text-amber-400 mb-4">Redeem a memory code to access your trophy content!</p>
                                    <button
                                        onClick={() => router.push('/codecheck')}
                                        className="bg-orange-600 hover:bg-orange-700 text-amber-100 px-6 py-2 rounded-lg transition-colors"
                                    >
                                ...
                                <div className="space-y-4">
                                    {memoryCodes.map((mount) => (
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <h3 className="font-medium text-amber-100 font-mono">{mount.name || mount.id}</h3>
                                                    <p className="text-sm text-amber-300">
                                                        Redeemed on {formatDate(mount.usedAt)}
                                                    </p>
                                                </div>
                                                <div className="text-right">
                                                    <span className="inline-block px-2 py-1 bg-green-800 text-green-200 rounded text-xs font-medium">
                                                        Active
                                                    </span>
                                                </div>
                                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="border border-amber-700 rounded-lg p-4" style={{backgroundColor: '#5c3a26'}}>
                                    <h3 className="font-medium text-amber-100 mb-2">Password</h3>
                                    <p className="text-amber-300 text-sm mb-3">Change your account password</p>
                                    <button className="bg-orange-600 hover:bg-orange-700 text-amber-100 px-4 py-2 rounded transition-colors">
                                        Change Password
                                    </button>
                                </div>
                                ...
                                <div className="bg-red-900 border border-red-700 rounded-lg p-4">
                                    <h3 className="font-medium text-amber-100 mb-2">Danger Zone</h3>
                                    <p className="text-amber-200 text-sm mb-3">Permanently delete your account and all data</p>
