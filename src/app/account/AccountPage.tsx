    ...
    return (
        <div className="min-h-screen bg-darker py-10 px-4 md:px-10 text-gray-100">
            <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-primary-gold">{userData?.email}</p>
                ...
                {/* Navigation Tabs */}
                <div className="bg-primary-dark shadow-lg rounded-lg mb-6">
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`flex items-center space-x-2 px-6 py-4 text-sm font-medium transition-colors ${activeTab === id
                                    ? 'bg-primary-light border-b-2 border-primary-dark'
                                    : 'text-primary-gold hover:text-primary-dark'
                                    }`}
                            >
                                <Icon size={16} />
                                <span>{label}</span>
                ...
                {/* Tab Content */}
                <div className="bg-primary-dark shadow-lg rounded-lg p-6">
                    {error && (
                    ...
                    {activeTab === 'profile' && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <h2 className="text-l font-semibold text-primary-dark mr-3">Profile Information</h2>
                                <button
                                    onClick={() => setIsEditing(!isEditing)}
                                    className="flex items-center space-x-2 bg-primary-neutral hover:bg-primary-light text-primary-dark px-4 py-2 rounded-lg transition-colors"
                                >
                                    <Edit size={16} />
                            ...
                            {isEditing ? (
                                <form onSubmit={handleUpdateProfile} className="space-y-4">
                                    ...
                                    <div className="flex space-x-3">
                                        <button
                                            type="submit"
                                            className="bg-primary-neutral hover:bg-primary-light text-primary-dark px-6 py-2 rounded-lg transition-colors"
                                        >
                                            Save Changes
                                        </button>
                                        <button
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        <div>
                                            <label className="block text-sm font-medium text-primary-gold">Name</label>
                                            <p className="text-neutral">{userData?.name || 'Not provided'}</p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-primary-gold">Email</label>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <label className="block text-sm font-medium text-primary-gold">Member Since</label>
                                            <p className="text-neutral">{userData?.createdAt ? formatDate(userData.createdAt) : 'Unknown'}</p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-primary-gold">Total Trophies</label>
                                            <p className="text-neutral">{trophies.length}</p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-primary-gold">Memory Codes Used</label>
                                            <p className="text-neutral">{memoryCodes.length}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                    ...
                    {activeTab === 'trophies' && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <h2 className="text-xl font-semibold text-primary-dark">My Trophies</h2>
                            </div>

                            {trophies.length === 0 ? (
                                <div className="text-center py-12">
                                    <Award size={48} className="mx-auto text-gray-500 mb-4" />
                                    <h3 className="text-lg font-medium text-primary-gold mb-2">No trophies yet</h3>
                                        ...
                                        >
                                            <div className="flex items-start justify-between mb-3">
                                                ...
                                                <div className="flex space-x-1">
                                                    {trophy.hasVideo && <Camera size={16} className="bg-primary-light" />}
                                                    {trophy.hasImages && <Star size={16} className="text-yellow-400" />}
                                                </div>
                                            </div>
                                            <div className="space-y-2 text-sm text-primary-gold">
                    ...
                    {activeTab === 'codes' && (
                        <div className="space-y-6">
                            <div className="flex items-center justify-between">
                                <h2 className="text-xl font-semibold text-primary-dark">Memory Mounts</h2>
                                <button
                            ...
                            {memoryCodes.length === 0 ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-lg font-medium text-primary-gold mb-2">No memory codes redeemed</h3>
                                ...
                                <div className="space-y-4">
                                    {memoryCodes.map((mount) => (
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <h3 className="font-medium text-primary-dark font-mono">{mount.name || mount.id}</h3>
                    ...
                    {activeTab === 'settings' && (
                        <div className="space-y-6">
                            <h2 className="text-xl font-semibold text-primary-dark">Account Settings</h2>

                            <div className="space-y-4">
                                <div className="bg-primary-light border border-gray-600 rounded-lg p-4">
                                    <h3 className="font-medium text-primary-dark mb-2">Password</h3>
                                    <p className="text-primary-gold text-sm mb-3">Change your account password</p>
                                    <button className="bg-primary-neutral hover:bg-primary-light text-primary-dark px-4 py-2 rounded transition-colors">
                                        Change Password
                                    </button>
                                </div>

                                <div className="bg-primary-light border border-gray-600 rounded-lg p-4">
                                    <h3 className="font-medium text-primary-dark mb-2">Privacy</h3>
                                    <p className="text-primary-gold text-sm mb-3">Manage your privacy settings</p>
                                    <button className="bg-primary-neutral hover:bg-primary-light text-primary-dark px-4 py-2 rounded transition-colors">
                                        Privacy Settings
                                    </button>
                                </div>
                                ...
                                <div className="bg-red-900 border border-red-700 rounded-lg p-4">
                                    ...
                                    <p className="text-primary-gold text-sm mb-3">Permanently delete your account and all data</p>
