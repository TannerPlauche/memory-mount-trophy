...
// ES Modules version of the migration script
// Usage: node scripts/migrate-memory-codes.mjs
...
//   const mongoUri = process.env.MONGODB_URI || 'mongodb://localhost:27017/trophy-mount';
  ...
  try {
    await mongoose.connect("mongodb+srv://admin:admin@dev.bymatt3.mongodb.net/?retryWrites=true&w=majority&appName=dev");
